...
from twitter.twitter_assistant import Twitter
    ...
    def _run_task(self):
        ...
        with Assistant(credentials) as assistant:
            ...
            for event in assistant.start():
                self._process_event(event, assistant)
    ...
    def _process_event(self, event, assistant):
        ...
        if event.type == EventType.ON_START_FINISHED:
            ...
            if text == 'power off':
                ...
                self.exit = True;
                turn_off_light()
            elif 'tell twitter' in text: #'ask Twitter' in text:
                assistant.stop_conversation()
        ...
        elif event.type == EventType.ON_RESPONDING_FINISHED and self.exit:
            sys.exit(1)
